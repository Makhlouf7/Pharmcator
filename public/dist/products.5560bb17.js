...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"dashboard/products.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return (0, _alerts.showConfirmDialog)("You are about to delete this product");
        case 3:
          if (!_context.sent) {
            _context.next = 13;
            break;
          ...
          _context.next = 7;
          return (0, _apiRequest.apiRequest)("DELETE", endpoint);
        case 7:
          (0, _alerts.showAlert)("Deleted successfully", "success");
          _context.next = 10;
  ...
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        ...
        (0, _alerts.toggleLoader)("show");
        _context2.next = 4;
        return (0, _apiRequest.apiRequest)("GET", "api/v1/category/".concat(id));
      case 4:
        res = _context2.sent;
