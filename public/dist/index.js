...
exports.toggleLoader = exports.showConfirmDialog = exports.showAlert = void 0;
...
var showAlert = exports.showAlert = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(message, type) {
    var time,
      alert,
      _args = arguments;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          time = _args.length > 2 && _args[2] !== undefined ? _args[2] : 2000;
          alert = document.createElement("div");
          alert.textContent = message;
          alert.style.cssText = "\n    position: fixed;\n    top: 0;\n    left: 50%;\n    text-align: center;\n    min-width: 200px;\n    transform: translateX(-50%);\n    background-color: ".concat(type === "success" ? "#28a745" : "#dc3545", ";\n    color: white;\n    padding: 1rem 2rem;\n    box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);\n    z-index: 2000;\n    font-size: 1rem;\n  ");
  ...
  return function showAlert(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

// Function to show or hide a loader
var toggleLoader = exports.toggleLoader = function toggleLoader(action) {
...
var showConfirmDialog = exports.showConfirmDialog = /*#__PURE__*/function () {
  ...
  return function showConfirmDialog(_x3) {
    return _ref2.apply(this, arguments);
  };
}();
},{}],"apiRequest.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: method,
            url: "".concat(serverUrl, "/").concat(url),
            data: data
          });
        case 4:
          res = _context.sent;
        ...
        case 8:
          ...
          errorMessage = ((_err$response = _context.t0.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || "Oops something went wrong";
          (0, _alerts.toggleLoader)("hide");
          _context.next = 14;
          return (0, _alerts.showAlert)(errorMessage, "error", 4000);
        case 14:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"shared.js":[function(require,module,exports) {
"use strict";
...
// Event Handlers =====
if (logoutBtn) logoutBtn.addEventListener("click", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  var res;
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.prev = 0;
        _context.next = 3;
        return (0, _apiRequest.apiRequest)("POST", "api/v1/users/logout");
      case 3:
        res = _context.sent;
...
},{"./apiRequest":"apiRequest.js"}],"../../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var page = document.querySelector("html").dataset.page;
console.log(page);
_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
  return _regeneratorRuntime().wrap(function _callee$(_context) {
    while (1) switch (_context.prev = _context.next) {
      case 0:
        _context.t0 = page;
        _context.next = _context.t0 === "main" ? 3 : _context.t0 === "register" ? 6 : _context.t0 === "login" ? 9 : _context.t0 === "cart" ? 12 : _context.t0 === "form" ? 15 : _context.t0 === "productDetails" ? 18 : _context.t0 === "dashboard/index" ? 21 : _context.t0 === "dashboard/categories" ? 24 : _context.t0 === "dashboard/products" ? 27 : 31;
        break;
      case 3:
        _context.next = 5;
        return require("_bundle_loader")(require.resolve("./main.js"));
      case 5:
        return _context.abrupt("break", 31);
      case 6:
        _context.next = 8;
        return require("_bundle_loader")(require.resolve("./register.js"));
      case 8:
        return _context.abrupt("break", 31);
      case 9:
        _context.next = 11;
        return require("_bundle_loader")(require.resolve("./login.js"));
      case 11:
        return _context.abrupt("break", 31);
      case 12:
        _context.next = 14;
        return require("_bundle_loader")(require.resolve("./cart.js"));
      case 14:
        return _context.abrupt("break", 31);
      case 15:
        _context.next = 17;
        return require("_bundle_loader")(require.resolve("./collectFormSendRequest.js"));
      case 17:
        return _context.abrupt("break", 31);
      case 18:
        _context.next = 20;
        return require("_bundle_loader")(require.resolve("./productDetails.js"));
      case 20:
        return _context.abrupt("break", 31);
      case 21:
        _context.next = 23;
        return require("_bundle_loader")(require.resolve("./dashboard/index.js"));
      case 23:
        return _context.abrupt("break", 31);
      case 24:
        _context.next = 26;
        return require("_bundle_loader")(require.resolve("./dashboard/categories.js"));
      case 26:
        return _context.abrupt("break", 31);
      case 27:
        console.log("Entered Products");
        _context.next = 30;
        return require("_bundle_loader")(require.resolve("./dashboard/products.js"));
      case 30:
        return _context.abrupt("break", 31);
      case 31:
      case "end":
...
},{"bootstrap/dist/css/bootstrap.min.css":"../../node_modules/bootstrap/dist/css/bootstrap.min.css","bootstrap":"../../node_modules/bootstrap/dist/js/bootstrap.esm.js","./shared.js":"shared.js","_bundle_loader":"../../node_modules/parcel-bundler/src/builtins/bundle-loader.js","./main.js":[["main.1f19ae8e.js","main.js"],"main.1f19ae8e.css",["marker-shadow.fed7181e.png","../../node_modules/leaflet/dist/images/marker-shadow.png"],"main.js"],"./register.js":[["register.61539755.js","register.js"],"register.js"],"./login.js":[["login.5087793e.js","login.js"],"login.js"],"./cart.js":[["cart.5e0824ae.js","cart.js"],"cart.js"],"./collectFormSendRequest.js":[["collectFormSendRequest.1743221b.js","collectFormSendRequest.js"],"collectFormSendRequest.js"],"./productDetails.js":[["productDetails.bd858063.js","productDetails.js"],"productDetails.js"],"./dashboard/index.js":[["dashboard.20f8ccf4.js","dashboard/index.js"],"dashboard/index.js"],"./dashboard/categories.js":[["categories.470c0fec.js","dashboard/categories.js"],"dashboard/categories.js"],"./dashboard/products.js":[["products.5560bb17.js","dashboard/products.js"],"dashboard/products.js"]}],"formUtils.js":[function(require,module,exports) {
"use strict";
...
var getFormData = exports.getFormData = function getFormData(formEl) {
  var formData = new FormData(formEl);
  var formObj = {};
  formData.forEach(function (value, key) {
    return formObj[key] = value;
  });
  return formObj;
};
